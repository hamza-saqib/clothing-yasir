    ...
    <div class="account-area ptb-80">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <form method="POST" action="{{ route('password.update') }}" class="login-side">
                        @csrf
                        <input type="hidden" name="token" value="{{ $token }}">
                        ...
                        <div class="login-reg">
                            ...
                            <div class="input-box mb-20">
                                ...
                                <input type="email" placeholder="E-Mail" name="email"
                                    class="info @error('email') is-invalid @enderror" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="frm-action">
                            <div class="input-box tci-box">
                                <a role="button" type="submit" onclick="$(this).closest('form').submit();"
                                    class="btn-def btn2">Reset Password</a>
                            </div>
                        </div>
                    </form>
                </div>
